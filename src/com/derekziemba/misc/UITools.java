...
public class UITools {
	...
	public static void createDialog(int titleId, int messageId, 
			int positiveTextId, DialogInterface.OnClickListener positiveAction,	
			int negativeTextId, DialogInterface.OnClickListener negativeAction, Context context	) 
	{
	...
	public static void createSliderDialog(	int titleId, final int messageId, int max, 
			int positiveTextId, DialogInterface.OnClickListener positiveAction, final Context context	) 
	{
		final View content = LayoutInflater.from(context).inflate(R.layout.new_maximum_layout, null);
		...
		seekBar.setOnSeekBarChangeListener(	
			new SeekBar.OnSeekBarChangeListener() {
				...
				public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
					textView.setText(context.getText(R.string.slider_instructions).toString()
		...
		AlertDialog.Builder alertDialog = new AlertDialog.Builder(context)
			.setTitle(R.string.set_maximum).setTitle(titleId).setView(content);
...
/*
	public static boolean createErrorDialog(final Activity context, UITools.Errors error) {
		...
		switch (error) {
			...
			break;			
		case NO_ROOT:
			UITools.createDialog(R.string.error, R.string.device_not_rooted, 0, null, R.string.ok, dismiss,context);
			break;
		case NO_ROOT_ACCESS:
			UITools.createDialog(R.string.error, R.string.root_access_not_given, 0, null, R.string.ok, dismiss,context);
			break;
		default:
			break;
		}
